...
jQuery('document').ready(function() {
	if (jQuery('#groupinc_configuration_form #mode').val() == 2) {
...
jQuery(document).ready(function() {
	$("input:radio[name=filter_prices], input:radio[name=filter_stock], input:radio[name=filter_store], input:radio[name=filter_weight]").click(function() {
