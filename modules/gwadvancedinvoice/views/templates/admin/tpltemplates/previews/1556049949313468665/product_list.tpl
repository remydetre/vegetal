<table class="product" width="100%" cellpadding="5" cellspacing="0">
    <thead>
    	<tr>
                            ...
                            <th class="product header small  alignleft " width="62%">Produit</th>
                            <th class="product header small  aligncenter " width="7%">Quantité</th>
                            <th class="product header small  aligncenter " width="10%">Prix </th>
                            <th class="product header small  aligncenter " width="13%">Taux TVA</th>
                    </tr>
    </thead>
	<tbody>
	...
	{foreach $order_details as $order_detail}
		...
		<tr class="product {$bgcolor_class}">
                           ...
                           <td class="product  alignleft "  width="62%"><p class="product_name">{$order_detail.product_name}</p>REF: {$order_detail.product_reference} - {$order_detail.feature6}</td>
                           <td class="product  aligncenter "  width="7%">{$order_detail.product_quantity}</td>
                           <td class="product  aligncenter "  width="10%">{displayPrice currency=$order->id_currency price=$total_products}</td>
                           <td class="product  aligncenter "  width="13%">{$order_detail.order_detail_tax_label}</td>
            		</tr>
