<table class="product" width="100%" cellpadding="5" cellspacing="0">
    <thead>
    	<tr>
                            ...
                            <th class="product header small  alignleft " width="65%">Product</th>
                            <th class="product header small  aligncenter " width="9%">Qty</th>
                            <th class="product header small  aligncenter " width="16%">Barcode</th>
                    </tr>
    </thead>
	<tbody>
	...
	{foreach $order_details as $order_detail}
		...
		<tr class="product {$bgcolor_class}">
                           ...
                           <td class="product  alignleft "  width="65%"><p class="product_name">{$order_detail.product_name}</p>{$order_detail.description_short}</td>
                           <td class="product  aligncenter "  width="9%">{$order_detail.product_quantity}</td>
                           <td class="product  aligncenter "  width="16%">{$order_detail.barcode}</td>
            		</tr>
