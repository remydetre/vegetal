<table class="product" width="100%" cellpadding="5" cellspacing="0">
    <thead>
    	<tr>
                            <th class="product header small  aligncenter " width="8%">Barcode</th>
                            <th class="product header small  alignleft " width="67%">Product</th>
                            <th class="product header small  aligncenter " width="10%">Barcode</th>
                            <th class="product header small  aligncenter " width="15%">Barcode</th>
                    </tr>
    </thead>
	<tbody>
	...
	{foreach $order_details as $order_detail}
		...
		<tr class="product {$bgcolor_class}">
			               ...
			               <td class="product  aligncenter "  width="8%">{$order_detail.barcode}</td>
                           <td class="product  alignleft "  width="67%"><p class="product_name">{$order_detail.product_name}</p>{$order_detail.description_short}</td>
                           <td class="product  aligncenter "  width="10%">{$order_detail.barcode}</td>
                           <td class="product  aligncenter "  width="15%">{$order_detail.barcode}</td>
            		</tr>
