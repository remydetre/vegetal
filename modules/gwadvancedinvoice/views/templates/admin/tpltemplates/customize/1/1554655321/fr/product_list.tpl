<table class="product" width="100%" cellpadding="5" cellspacing="0">
    <thead>
    	<tr>
                            <th class="product header small  aligncenter " width="8%">Image</th>
                            <th class="product header small  alignleft " width="48%">Produit</th>
                            <th class="product header small  aligncenter " width="13%">Prix unitaire HT</th>
                            <th class="product header small  aligncenter " width="9%">Quantité</th>
                            <th class="product header small  aligncenter " width="10%">Total</th>
                            <th class="product header small  aligncenter " width="12%">Taux TVA</th>
                    </tr>
    </thead>
	<tbody>
	...
	{foreach $order_details as $order_detail}
		...
		<tr class="product {$bgcolor_class}">
			               ...
			               <td class="product  aligncenter "  width="8%">{$order_detail.image_tag}</td>
                           <td class="product  alignleft "  width="48%"><p class="product_name">{$order_detail.product_name}</p>REF: {$order_detail.product_reference}</td>
                           <td class="product  aligncenter "  width="13%">{displayPrice currency=$order->id_currency price=$order_detail.unit_price_tax_excl_including_ecotax}</td>
                           <td class="product  aligncenter "  width="9%">{$order_detail.product_quantity}</td>
                           <td class="product  aligncenter "  width="10%">{displayPrice currency=$order->id_currency price=$order_detail.total_price_tax_excl_including_ecotax}</td>
                           <td class="product  aligncenter "  width="12%">{$order_detail.order_detail_tax_label}</td>
            		</tr>
