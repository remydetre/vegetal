<table class="product" width="100%" cellpadding="5" cellspacing="0">
    <thead>
    	<tr>
                            <th class="product header small  aligncenter " width="11%">Image</th>
                            <th class="product header small  alignleft " width="45%">Product</th>
                            <th class="product header small  aligncenter " width="16%">Prix unitaire HT</th>
                            <th class="product header small  aligncenter " width="12%">Quantité</th>
                            <th class="product header small  aligncenter " width="16%">Total</th>
                    </tr>
    </thead>
	<tbody>
	...
	{foreach $order_details as $order_detail}
		...
		<tr class="product {$bgcolor_class}">
			               ...
			               <td class="product  aligncenter "  width="11%">{$order_detail.image_tag}</td>
                           <td class="product  alignleft "  width="45%"><p class="product_name">{$order_detail.product_name}</p>{$order_detail.description_short}</td>
                           <td class="product  aligncenter "  width="16%">{displayPrice currency=$order->id_currency price=$order_detail.unit_price_tax_excl_including_ecotax}</td>
                           <td class="product  aligncenter "  width="12%">{$order_detail.product_quantity}</td>
