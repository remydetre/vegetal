<table class="product" width="100%" cellpadding="5" cellspacing="0">
    <thead>
    	<tr>
                            <th class="product header small  aligncenter " width="10%">Image</th>
                            <th class="product header small  alignleft " width="65%">Produit</th>
                            <th class="product header small  aligncenter " width="9%">Quantité</th>
                            <th class="product header small  aligncenter " width="16%">Poids unitaire</th>
                    </tr>
    </thead>
	<tbody>
	...
	{foreach $order_details as $order_detail}
		...
		<tr class="product {$bgcolor_class}">
			               ...
			               <td class="product  aligncenter "  width="10%">{$order_detail.image_tag}</td>
                           <td class="product  alignleft "  width="65%"><p class="product_name">{$order_detail.product_name}</p>REF: {$order_detail.product_reference} --- {$order_detail.description_short}</td>
                           <td class="product  aligncenter "  width="9%">{$order_detail.product_quantity}</td>
                           <td class="product  aligncenter "  width="16%">{$order_detail.product_weight}</td>
            		</tr>
