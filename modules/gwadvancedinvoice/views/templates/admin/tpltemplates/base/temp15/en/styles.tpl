...
<style>
    ...
    tr.color_line_even td{
        border-bottom: 2px solid {$color_product|escape:'htmlall':'UTF-8'};
    }
    ...
    tr.color_line_odd td{
        border-bottom: 2px solid {$color_product|escape:'htmlall':'UTF-8'};
    }
    .border-left{
        background-color:{$bodytextcolor|escape:'htmlall':'UTF-8'};
    }
    .border-white{
    ...
    .add_label{
        color:{$color_thank_for|escape:'htmlall':'UTF-8'};
        border-right:2px solid {$bodytextcolor|escape:'htmlall':'UTF-8'};
    }
    .invoice_title{
