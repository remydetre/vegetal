...
{if !isset($total_title_background)|| $total_title_background == ''}{assign var=total_title_background value="#ef9c00"}{/if}
{if !isset($total_item_background)|| $total_item_background == ''}{assign var=total_item_background value="#f8eed4"}{/if}
...
<style>
    ...
    .color_footer{
        color: {$footer_background|escape:'htmlall':'UTF-8'};
    }
    .payment_method{
    ...
    th.total_title_background{
        background-color:{$total_title_background|escape:'htmlall':'UTF-8'};
    }
    td.total_title_background{
        background-color:{$total_title_background|escape:'htmlall':'UTF-8'};
    }
    tr.product td.totalitembackground{
        background-color:{$total_item_background|escape:'htmlall':'UTF-8'};
    }
    p.product_name{
        color:{$color_strong|escape:'htmlall':'UTF-8'};
        font-weight:bold;
    ...
    .total_box table td p,.total_box table td{
        color:{$headingtextcolor|escape:'htmlall':'UTF-8'};
    }
    .total_box table td .strong_item{
        color:{$color_invoice|escape:'htmlall':'UTF-8'};
    }
    .border_right{
        border-right:2px solid {$color_title|escape:'htmlall':'UTF-8'};
        text-align:right;
    }
    .border_left{
        border-left:2px solid {$color_title|escape:'htmlall':'UTF-8'};
        text-align:left;
    }
    .align_right{
        text-align:right;
