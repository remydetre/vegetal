...
<style>
    ...
    .border_bottom{
        border-bottom:2px solid {$bodytextcolor|escape:'htmlall':'UTF-8'};
    }
    .alignleft{
        text-align:left;
    }
	...
	th.product {
	border-bottom: 1px solid {$headingblockbackground|escape:'htmlall':'UTF-8'};
	}
    ...
    .border-top td{
         border-top:1px solid {$bodytextcolor|escape:'htmlall':'UTF-8'};
    }
