...
<style>
    ...
    .total_wp{
         ...
         border:2px solid {$headingblockbackground|escape:'htmlall':'UTF-8'};
    }
	...
	th.header {
		...
		color:{$headingblockbackground|escape:'htmlall':'UTF-8'};
        background-color:{$color_line_odd|escape:'htmlall':'UTF-8'};
		vertical-align: middle;
	}
    ...
    .top_border{
        border-top:2px solid {$headingblockbackground|escape:'htmlall':'UTF-8'};
    }
    .border-total{
        border-bottom:3px solid {$headingblockbackground|escape:'htmlall':'UTF-8'};
    }
