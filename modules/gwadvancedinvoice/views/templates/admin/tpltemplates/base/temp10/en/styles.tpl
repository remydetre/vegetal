...
{if !isset($font_shoptitle)|| $font_shoptitle == ''}{assign var=font_shoptitle value=$bodytextfont}{/if}
{if !isset($size_shoptitle)|| $size_shoptitle == ''}{assign var=size_shoptitle value="15pt"}{/if}
{if !isset($color_shoptitle)|| $color_shoptitle == ''}{assign var=color_shoptitle value="#333"}{/if}
...
<style>
    ...
    .border_bottom{
        border-bottom:3px solid {$bodytextcolor|escape:'htmlall':'UTF-8'};
    }
    .alignleft{
        text-align:left;
    }
	...
	tr.product td,tr.product table tr td {
		border: 1px solid {$color_border|escape:'htmlall':'UTF-8'};
    ...
    .total_box{
        border:1px solid {$headingblockbackground|escape:'htmlall':'UTF-8'};
    }
