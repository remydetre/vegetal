...
<body style="background: {{$body_color}};">
  <div style="background-color:{{$body_color}};"><!--[if mso | IE]>
      ...
      <![endif]--><div class="mj-column-per-100 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%;"><table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0"><tbody>{{if !empty($icon_size) && $icon_size > 0}}{{if !empty($icon_color) && $icon_color == 'light'}}<tr><td style="word-wrap:break-word;font-size:0px;padding:5px;" align="center"><table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0px;" align="center" border="0"><tbody><tr><td style="width:{{$icon_size}}px;"><img alt="${{ lang.hi_firstname_lastname }}$" title="" height="auto" src="{{$mails_img_url}}user2_l.png" style="border:none;border-radius:0px;display:block;outline:none;text-decoration:none;width:100%;height:auto;" width="{{$icon_size}}"></td></tr></tbody></table></td></tr>{{else}}<tr><td style="word-wrap:break-word;font-size:0px;padding:5px;" align="center"><table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0px;" align="center" border="0"><tbody><tr><td style="width:{{$icon_size}}px;"><img alt="${{ lang.hi_firstname_lastname }}$" title="" height="auto" src="{{$mails_img_url}}user2.png" style="border:none;border-radius:0px;display:block;outline:none;text-decoration:none;width:100%;height:auto;" width="{{$icon_size}}"></td></tr></tbody></table></td></tr>{{/if}}{{/if}}</tbody></table></div><!--[if mso | IE]>
      </td></tr></table>
      <![endif]--></td></tr></tbody></table></div><!--[if mso | IE]>
      </td></tr><tr><td style="width:650px;">
