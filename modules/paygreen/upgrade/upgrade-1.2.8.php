...
function upgrade_module_1_2_8($object)
{
    ...
    $container->get('logger')->warning("Upgrade module 1.2.8");
    ...
    $result = $databaseHandler->runScript('upgrades/upgrade-1.2.8.sql');

    $container->get('handler.setup')->runDelayedUpgrade('1.2.8');
