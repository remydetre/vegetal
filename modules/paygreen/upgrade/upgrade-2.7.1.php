...
function upgrade_module_2_7_1($object)
{
    ...
    $container->get('logger')->warning("Upgrade module 2.7.1");
    ...
    $result = $databaseHandler->runScript('upgrades/upgrade-2.7.1.sql');

    $container->get('handler.setup')->runDelayedUpgrade('2.7.1');
