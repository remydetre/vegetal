...
function upgrade_module_1_3_1($object)
{
    ...
    $container->get('logger')->warning("Upgrade module 1.3.1");
    ...
    $result = $databaseHandler->runScript('upgrades/upgrade-1.3.1.sql');

    $container->get('handler.setup')->runDelayedUpgrade('1.3.1');
