...
function upgrade_module_2_3_0($object)
{
    ...
    $container->get('logger')->warning("Upgrade module 2.3.0");
    ...
    $result = $databaseHandler->runScript('upgrades/upgrade-2.3.0.sql');

    $container->get('handler.setup')->runDelayedUpgrade('2.3.0');
