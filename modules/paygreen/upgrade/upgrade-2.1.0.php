...
function upgrade_module_2_1_0($object)
{
    ...
    $container->get('logger')->warning("Upgrade module 2.1.0");
    ...
    $result = $databaseHandler->runScript('upgrades/upgrade-2.1.0.sql');

    $container->get('handler.setup')->runDelayedUpgrade('2.1.0');
