...
function upgrade_module_2_2_8($object)
{
    ...
    $container->get('logger')->warning("Upgrade module 2.2.8");
    ...
    $result = $databaseHandler->runScript('upgrades/upgrade-2.2.8.sql');

    $container->get('handler.setup')->runDelayedUpgrade('2.2.8');
