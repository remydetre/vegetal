...
function upgrade_module_1_3_0($object)
{
    ...
    $container->get('logger')->warning("Upgrade module 1.3.0");
    ...
    $result = $object->registerHook('postUpdateOrderStatus') &&
    $object->registerHook('ActionObjectOrderSlipAddAfter') &&
    $object->registerHook('displayFooter') &&
    $databaseHandler->runScript('upgrades/upgrade-1.3.0.sql');

    $container->get('handler.setup')->runDelayedUpgrade('1.3.0');
