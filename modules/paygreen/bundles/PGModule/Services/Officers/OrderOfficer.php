...
class PGModuleServicesOfficersOrderOfficer extends PGFrameworkFoundationsAbstractObject implements PGDomainInterfacesOfficersOrderOfficerInterface
{
    /**
     * @inheritDoc
     */
    public function updateOrder(PGDomainInterfacesEntitiesOrderInterface $order, $state)
    {
