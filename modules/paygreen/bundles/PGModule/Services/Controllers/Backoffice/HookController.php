...
class PGModuleServicesControllersBackofficeHookController extends PGServerFoundationsAbstractController
{
    public function refreshTopPositionAction()
    {
        ...
        if ($installHooksListener->updateHookPositions()) {
            $this->success('prestashop.backoffice.actions.hooks.result.success');
        } else {
            $this->failure('prestashop.backoffice.actions.hooks.result.failure');
        }
