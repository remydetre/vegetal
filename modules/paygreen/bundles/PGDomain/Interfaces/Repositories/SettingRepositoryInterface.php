...
/**
 * Interface PGDomainInterfacesRepositoriesSettingRepositoryInterface
 * @package PGDomain\Interfaces\Repositories
 */
interface PGDomainInterfacesRepositoriesSettingRepositoryInterface extends PGFrameworkInterfacesRepositoryInterface
{
    /**
    ...
    /**
     * @param PGDomainInterfacesEntitiesSettingInterface $setting
     * @return bool
     */
