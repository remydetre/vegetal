...
// This action is now replaced by the Front Module Controller `paymentNotification` in controllers/front
...
if ($paymentHandler->validateWebPayment($_REQUEST['pid'], true)) {
