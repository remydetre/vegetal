...
<div class="form_more content_form p_{$ps_version|replace:'.':''|escape:'quotes':'UTF-8'}">
	...
	<div class="form-group" {if $product->is_virtual}style="display:none;"{/if} class="row stockForVirtualProduct">
		<div class="col-lg-9 col-lg-offset-3">
            ...
            {if $stock_management_active == 0 && !$product->cache_is_pack}
				<p class="help-block"><i class="icon-warning-sign"></i>&nbsp;{l s='This requires you to enable advanced stock management.'  mod='dgridproducts'}</p>
	...
	<div {if $product->is_virtual}style="display:none;"{/if} class="form-group stockForVirtualProduct">
		<label class="control-label col-lg-3" for="depends_on_stock_1">{l s='Available stock management'  mod='dgridproducts'}</label>
		<div class="col-lg-9">
			<p class="radio">
            ...
            {if $product->cache_is_pack}
				<p class="help-block">
                    {l s='You cannot use advanced stock management for this pack if'  mod='dgridproducts'}<br />
                    {l s='- advanced stock management is not enabled for these products'  mod='dgridproducts'}<br />
	...
	<div id="when_out_of_stock" class="form-group">
		<label class="control-label col-lg-3">{l s='When out of stock'  mod='dgridproducts'}</label>
		<div class="col-lg-9">
			<p class="radio">
