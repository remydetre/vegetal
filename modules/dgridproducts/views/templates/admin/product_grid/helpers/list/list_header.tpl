            ...
            <div class="col-lg-6 search-products">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group clearfix">
                        ...
                        <select name="attribute_group" class="fixed-width-lg" id="select_attribute">
                        ...
                        <button id="btn_list" class="btn {if $search_attributes[0]}open btn-danger{else}btn-success{/if}">
                    ...
                    {foreach from=$attribute_groups item=attribute_group}
                        <div class="form-group clearfix data-attribute-values"
                             style="display: none;"
