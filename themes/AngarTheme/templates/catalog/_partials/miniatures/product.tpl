		...
		<div class="product-right">
			<div class="product-description">
				...
				{if isset ($product.manufacturer_name) && $product.manufacturer_name neq ''}
					...
					{if $psversion > ps_172}
						<a href="{$link->getmanufacturerLink($product.id_manufacturer, $product.id_manufacturer)}" title="{$product.manufacturer_name}"><strong>{$product.manufacturer_name}</strong></a>
					{else}
