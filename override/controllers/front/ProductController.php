...
class ProductController extends ProductControllerCore
{
    ...
    */
    public function initContent()
    {
        ...
        $id_state = $address->id_state;
        $id_product = $this->product->id;
        $onsaleconf = $groupinc->getGIConfigurations($id_shop, $id_product, $id_customer, $id_country, $id_state, $id_currency, $this->context->language->id, true, true, 0, false, true);
        if (!empty($onsaleconf)) {
